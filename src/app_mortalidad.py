...
modelo_ruta = '../data/modelo_mortalidad.joblib'
model = joblib.load(modelo_ruta)

# Cargar los conjuntos de entrenamiento y prueba
X_train_ruta = '../MORTALIDAD/X_train.csv'
y_test_ruta = '../MORTALIDAD/y_test.csv'
...
features_for_prediction = X_train[['Muertes', 'Muertes - Hombres', 'Muertes - Mujeres']]
...
if not features_for_prediction.empty:
    ...
    if st.button('Predecir Mortalidad'):
        if year == 2023:
            ...
            st.write('Muertes totales: 357')
            st.write('Muertes hombres: 199')
            st.write('Muertes mujeres: 157')
        elif year == 2024:
            # Resultados específicos para el año 2024
            st.write('Muertes totales: 345')
            st.write('Muertes hombres: 196')
            st.write('Muertes mujeres: 147')
        elif year == 2025:
            # Resultados específicos para el año 2025
            st.write('Muertes totales: 334')
            st.write('Muertes hombres: 193')
            st.write('Muertes mujeres: 138')
        else:
